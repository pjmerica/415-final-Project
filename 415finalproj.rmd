...
scaledlifetrain = scale(filteredTrain2, center = colm, scale = colsd) #scaling
scaledlifetest = scale(filtertest2, center = colm, scale = colsd)

k_range = c(1,3,5,10,25,50,75,100, 125, 150, 175,200) #k range
...
testMSE2[i] <- mean((trainlife$Life_Expectancy - knnTest$pred)^2)
}
plot(trainMSE1 ~ I(1/k_range), type = "b", lwd = 2, col = "blue",
main = "Training and Test MSE for KNN", xlab = "1/K", ylab = "MSE", ylim = c(0,200),
xlim= c(0,1) ) #plotting
# Add the test MSE
...
lassocoef = predict(lasso.mod, type = "coefficient", s = bestlam)
