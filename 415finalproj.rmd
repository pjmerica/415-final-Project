...
k_range = c(1,4,7,10,13,16,19,22,25,28,31,34,40) #k range
...
plot(trainMSE1 ~ k_range, type = "b", lwd = 2, col = "blue",
main = "Training and Test MSE for KNN", xlab = "K", ylab = "MSE", ylim = c(0,20),
xlim= c(0,40) ) #plotting
# Add the test MSE
lines(testMSE1 ~ k_range, type = "b", lwd = 2, col = "red")
#testMSE2
...
plot(trainMSE2 ~ k_range, type = "b", lwd = 2, col = "blue",
main = "Training and Test MSE for KNN", xlab = "K", ylab = "MSE", ylim = c(0,20),
xlim= c(0,40) ) #plotting
# Add the test MSE
lines(testMSE2 ~ k_range, type = "b", lwd = 2, col = "red")
#testMSE2
legend("topleft", legend = c("Training KNN", "Test KNN"), cex = 0.75, col = c("blue", "red"), lwd =
c(2, 2), pch = c(1, 1), lty = c(1, 1))
...
```
#Now test MSE with larger lambda
```{r}
lasso.pred_train2 = predict(lasso.mod, s=bestlamse, newx=trainmatrix)
mean((lasso.pred_train2 - trainlife$Life_Expectancy)^2)

lasso.pred_test2 = predict(lasso.mod, s=bestlamse, newx=testmatrix)
mean((lasso.pred_test2- testlife$Life_Expectancy)^2)
