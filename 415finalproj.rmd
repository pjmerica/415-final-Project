...
train_mseexp = mean((train_exppredict - trainlife$Life_Expectancy)^2)
train_mseexp
test_exppredict = predict.lm(expmod, testlife)
test_mseexp = mean((test_exppredict - testlife$Life_Expectancy)^2)
test_mseexp
train_exppredict2 = predict.lm(expmod2, trainlife)
train_mseexp2 = mean((train_exppredict2 - trainlife$Life_Expectancy)^2)
train_mseexp2
test_exppredict2 = predict.lm(expmod2, testlife)
test_mseexp2 = mean((test_exppredict2 - testlife$Life_Expectancy)^2)
test_mseexp2 
```
