...
importance(rf.life)
boost.life = gbm(Life_Expectancy ~ ., data = trainlife, distribution = "gaussian", n.trees = 5000, interaction.depth = 4)
summary(boost.life)
varImpPlot(rf.life)
bst <- xgboost(
  data = data.matrix(subset(trainlife, select = -Life_Expectancy)),
  label = trainlife$Life_Expectancy, 
